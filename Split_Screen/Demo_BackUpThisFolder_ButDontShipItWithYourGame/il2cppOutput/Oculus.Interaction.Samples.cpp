...
// System.Void Oculus.Interaction.Samples.RespawnOnDrop::Respawn()
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void RespawnOnDrop_Respawn_m9D701BC27BEE236CBCFE354880D0171E36435F4C (RespawnOnDrop_tDA2EEBCEC4DB067F54616A6142CAEE71C83FD8FB* __this, const RuntimeMethod* method) 
{
	...
	int32_t V_1 = 0;
	{
		...
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_0;
		L_0 = Component_get_transform_m2919A1D81931E6932C7F06D4C2F0AB8DDA9A5371(__this, NULL);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_1 = __this->____initialPosition_6;
		NullCheck(L_0);
		Transform_set_position_mA1A817124BB41B685043DED2A9BA48CDF37C4156(L_0, L_1, NULL);
		// transform.rotation = _initialRotation;
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_2;
		L_2 = Component_get_transform_m2919A1D81931E6932C7F06D4C2F0AB8DDA9A5371(__this, NULL);
		Quaternion_tDA59F214EF07D7700B26E40E562F267AF7306974 L_3 = __this->____initialRotation_7;
		NullCheck(L_2);
		Transform_set_rotation_m61340DE74726CF0F9946743A727C4D444397331D(L_2, L_3, NULL);
		// transform.localScale = _initialScale;
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_4;
		L_4 = Component_get_transform_m2919A1D81931E6932C7F06D4C2F0AB8DDA9A5371(__this, NULL);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_5 = __this->____initialScale_8;
		NullCheck(L_4);
	...
	}
	{
		...
		Rigidbody_t268697F5A994213ED97393309870968BC1C7393C* L_8 = __this->____rigidBody_10;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_9;
...
IL_0060:
	{
		...
		TwoGrabFreeTransformerU5BU5D_t6321E9D2A47A7569F7FC2841D60D6D54AE877F4A* L_12 = __this->____freeTransformers_9;
		V_0 = L_12;
		V_1 = 0;
		goto IL_0077;
	}
...
IL_006b:
	{
		// foreach (var freeTransformer in _freeTransformers)
		TwoGrabFreeTransformerU5BU5D_t6321E9D2A47A7569F7FC2841D60D6D54AE877F4A* L_13 = V_0;
		int32_t L_14 = V_1;
		NullCheck(L_13);
		int32_t L_15 = L_14;
		TwoGrabFreeTransformer_t7D9C99C5A65190B2D195ADB3D9717BA6DC95C344* L_16 = (L_13)->GetAt(static_cast<il2cpp_array_size_t>(L_15));
		// freeTransformer.MarkAsBaseScale();
		NullCheck(L_16);
		TwoGrabFreeTransformer_MarkAsBaseScale_m4B4C2BCB0D5D81DD50BE420226279EC4FBC76596(L_16, NULL);
		int32_t L_17 = V_1;
...
IL_0077:
	{
		// foreach (var freeTransformer in _freeTransformers)
		int32_t L_18 = V_1;
		TwoGrabFreeTransformerU5BU5D_t6321E9D2A47A7569F7FC2841D60D6D54AE877F4A* L_19 = V_0;
		NullCheck(L_19);
	...
	}
	{
		...
		UnityEvent_tDC2C3548799DBC91D1E3F3DE60083A66F4751977* L_20 = __this->____whenRespawned_5;
		NullCheck(L_20);
